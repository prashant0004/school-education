            ...
            <div className="flex flex-wrap gap-16 items-center justify-center  mt-10 ">
                {SchoolInfo.map((item) => (
                    <div key={item.id} className="flex flex-col border min-h-[400px] rounded-[10px] border-[black]  bg-[white] items-center justify-center mt-10 p-[30px]" style={{ boxShadow: "4px 4px 0px black", }}>
                        ...
                        <div className="flex justify-center mt-8 gap-3 w-[90%] "><div className="bg-[#FFBE99] lg:w-[15%] text-[black] p-2"></div><div className="bg-[#FFBE99] lg:w-[15%] text-[black] p-2"></div><div className="bg-[#FFBE99] lg:w-[15%] text-[black] p-2"></div><div className="bg-[#FFBE99] lg:w-[15%] text-[black] p-2"></div><div className="bg-[#FFBE99] lg:w-[15%] text-[black] p-2"></div><div className="bg-[#FFBE99] lg:w-[15%] text-[black] p-2"></div>
                        </div>
                        <div className="text-[16px] text-center max-w-[500px] mt-10 text-[#333333]">{item.description}</div>
                       
                        <button className="bg-[#FFDECC] mt-10 w-full border-[3px] border-[black] py-4 rounded-[10px]"> <Link to={item.link}>Learn More </Link></button>
