...
const Footer = () => {
    return (
        <div className="flex  bg-[#FFF5F0] py-[20px] px-5 justify-center ">
            <div className=" max-w-[1380px]  lg:p-[50px] lg:px-[100px] p-[40px] bg-white border-[3px] border-[black] rounded-[10px] " style={{ boxShadow: "4px 4px 0px black", }} >
                    ...
                    <div className="flex  flex-wrap gap-3 md:gap-6">
                        <div>
                            <ul className="flex flex-col gap-5">
                                <li className="md:text-[20px] text-[14px] font-[600]"><Link to="/">Home</Link></li>
                                <li className="md:text-[20px] text-[14px] ">Features</li>
                                <li className="md:text-[20px] text-[14px] ">Our Testimonials</li>
                                <li className="md:text-[20px] text-[14px] ">Faq</li>
                            </ul>
                        </div>
                        <div>
                            <ul className="flex flex-col  gap-5">
                                <li className="md:text-[20px] text-[14px] font-[600]"><Link to="/about">About Us</Link></li>
                                <li className="md:text-[20px] text-[14px]">Our Mission</li>
                                <li className="md:text-[20px] text-[14px]">Our Vission</li>
                                <li className="md:text-[20px] text-[14px]">Award and Recognitions</li>
                                <li className="md:text-[20px] text-[14px]">History</li>
                                <li className="md:text-[20px] text-[14px]">Teachers</li>
                            </ul>
                        </div>
                        <div>
                            <ul className="flex  flex-col gap-5">
                                <li className="md:text-[20px] text-[14px] font-[600]"><Link to="/academics">Academics</Link></li>
                                <li className="md:text-[20px] text-[14px]">Special Features</li>
                                <li className="md:text-[20px] text-[14px]">Gallery</li>
                            </ul>
                        </div>
                        <div>
                            <ul className="flex  flex-col gap-5">
                                <li className="md:text-[20px] text-[14px] font-[600]"><Link to="/contact">Contact</Link></li>
                                <li className="md:text-[20px] text-[14px]">Information</li>
                                <li className="md:text-[20px] text-[14px]">Map & Direction</li>
                            </ul>
                        </div>
                    </div>
                </div>
